...
![Página de inicio](Images/ss-home1.png)
![Página de inicio](Images/ss-home2.png)
*Página principal

![Página simular crédito](Images/ss-simular-credito.png)
*Página para la simulación de créditos

![Página de inicio](Images/ss-solicitar-credito.png)
